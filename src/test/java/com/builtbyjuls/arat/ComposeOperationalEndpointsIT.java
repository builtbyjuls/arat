...
class ComposeOperationalEndpointsIT extends PostgreSqlIntegrationTest {
    ...
    @Test
    void exposesPrometheusInComposeProfile() throws Exception {
    ...
    @Test
    void keepsSensitiveActuatorPathsUnavailableInComposeProfile() throws Exception {
