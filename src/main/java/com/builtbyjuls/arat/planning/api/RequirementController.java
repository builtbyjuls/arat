...
public class RequirementController {
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "409", description = "Plan does not allow collaboration", content = @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE, schema = @Schema(implementation = ApiProblemResponse.class))),
