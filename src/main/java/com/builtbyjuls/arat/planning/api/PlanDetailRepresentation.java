...
public record PlanDetailRepresentation(
        UUID planId,
        String title,
        String state,
        long version,
        RequirementRepresentation requirements) {

    public static PlanDetailRepresentation from(PrivatePlan privatePlan, ObjectMapper objectMapper) {
        ...
        return new PlanDetailRepresentation(
                plan.planId(),
                plan.title(),
                plan.state().name(),
                plan.version(),
                new RequirementRepresentation(
                        draft.category().name(),
                        draft.timeZone(),
